...
|space|Disciplina onde o canvas se encontra.|
|course|Curso onde o canvas se encontra.|
|environment|AVA onde o canvas se encontra.|
...
|name|Nome mostrado nos links para o Canvas|Obrigatório|
...
{% highlight json %}
{
  ...
  "links": [
    ...
    { "rel": "self", "href": "http://www.redu.com.br/api/canvas/107" },
    { "rel": "self_link", "href": "http://www.redu.com.br/espacos/27/canvas/107" },
