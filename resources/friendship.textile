...
|*type*| Filtragem pelos estados da conexão|N/A|

h2. "GET api/users/:user_id/connections/:id":#get-connection
...
h2. "POST /api/users/:user_id/connection":#post-user-connection
...
|*contact_id*| ID do novo contato |N/A|
...
h2. "DELETE /api/users/:user_id/connections/:connection_id":#delete-connection
