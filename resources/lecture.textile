...
|*lecture[type]*|{% t lecture.post_subjects_subject_id.table.lecture_type_description %}|{% t lecture.post_subjects_subject_id.table.lecture_type_restriction %}|
|*lecture[media]*|{% t lecture.post_subjects_subject_id.table.lecture_media_description %}|{% t lecture.post_subjects_subject_id.table.lecture_media_restriction %}|
|*lecture[content]*|{% t lecture.post_subjects_subject_id.table.content_description %}|{% t lecture.post_subjects_subject_id.table.content_restriction %}|
