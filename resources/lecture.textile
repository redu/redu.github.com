...
2. @Content-Length: 13951@ (em bytes)
...
curl \
  ...
  -F 'lecture[media]=@spec/fixtures/api/pdf_example.pdf;type=application/pdf' \
...
curl \
  -H 'Authorization: OAuth AJOBibdmecfKxOpEeRWbdmVVCGujGRU3JKA0jyQM' \
  -F 'lecture[content]=My <strong>lecture</strong> content.' \
  -F 'lecture[name]=My lecture' \
  -F 'lecture[type]=Page' \
  http://www.redu.com.br/api/subjects/117/lectures -vv
{% endhighlight %}
