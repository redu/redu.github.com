...
Em todos os exemplos é utilizado "cURL":http://curl.haxx.se/docs/manpage.html para testar a criação de Lecture. Um exemplo em Java pode ser encontrado "aqui":https://github.com/redu/oauth-consumers/tree/master/java-native/file-upload.
