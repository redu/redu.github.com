...
No contexto da API, a aula é referenciada como @lecture@. Uma aula representa um conteúdo mínimo, como um texto ou vídeo, que possui interações sociais (ver Mural). Várias aulas podem ser agrupadas e ordenadas em um módulo.
...
* *Vídeo:* Arquivo de vídeo (_mov_, _avi_, _mpeg_, _mp4_, etc) ou vídeo hospedado no "Youtube":http://www.youtube.com.
...
|type|Tipo (_Canvas, Document, Exercise, Page, Seminar_).|
|id|Identificador.|
