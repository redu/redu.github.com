...
No contexto da API disciplina é referida como @space@. É na disciplina que as interações sociais (ver mural) acontecem e o conteúdo (ver módulo) são postados. Note que atributos de requisições em negrito são obrigatórios.
