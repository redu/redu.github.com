...
table(table table-bordered table-striped).
|_.{% t global.parameter %}|_.{% t global.description %}|_.{% t global.restrictions %}|
|*space[name]*|{% t space.put_spaces_id.table.space_name_description %}|{% t space.put_spaces_id.table.space_name_restriction %}|
|space[description]|{% t space.put_spaces_id.table.space_description_description %}|{% t space.put_spaces_id.table.space_description_restriction %}|
...
|*space[name]*|{% t space.post_courses_course_id.table.space_name_description %}|{% t space.post_courses_course_id.table.space_name_restriction %}|
|space[description]|{% t space.post_courses_course_id.table.space_description_description %}|{% t space.post_courses_course_id.table.space_description_restriction %}|
