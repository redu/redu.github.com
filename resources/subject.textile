...
No contexto da API, o módulo é referido como @suject@. É um agrupamento de diversas aulas (conteúdos) em um contexto. Note que atributos de requisições em negrito são obrigatórios.
